package com.laboratorio5.lab5.controller;

import com.laboratorio5.lab5.model.Formulario;
import com.laboratorio5.lab5.repository.FormularioRepository;
...
public class FormularioController {
    ...
    public String submitEdicionFormulario(@ModelAttribute Formulario formulario, Model model) {
        ...
        return "redirect:/listarFormularios"; // Redirigir si no encuentra el formulario
    }
    ...
    public String eliminarFormulario(@PathVariable("id") Long id) {
        ...
        return "redirect:/listarFormularios"; // Redirigir al listado despues de eliminar
    }
}
